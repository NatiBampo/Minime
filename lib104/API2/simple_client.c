...
asduReceivedHandler (void* parameter, int address, CS101_ASDU asdu)
{
    ...
    if (CS101_ASDU_getTypeID(asdu) == M_ME_NB_1) //M_ME_TE_1
    {

        printf("  measured values scaled  with CP56Time2a timestamp:\n"); //
    ...
    else if (CS101_ASDU_getTypeID(asdu) == M_ME_NC_1) //short floating point
    {

        printf("  measured float values with CP56Time2a timestamp:\n");
...
{
    const char* ip = "localhost";//"192.168.5.51";//
